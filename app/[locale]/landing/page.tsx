...
const Sidebar: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    `}>
      ...
      <div className="mb-4">
        <SidebarItem icon="+" text={t('landing.new_course')} active />
      </div>

      <div className="space-y-1 mb-4">
        <SidebarItem icon={<BookOpen size={18} />} text={t('landing.my_courses')} />
        <SidebarItem icon={<StarIcon size={18} />} text={t('landing.staff_picks')} />
        <SidebarItem icon={<UsersIcon size={18} />} text={t('landing.community')} />
      </div>
