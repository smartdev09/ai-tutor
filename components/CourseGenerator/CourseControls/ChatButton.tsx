...
export function ChatButton({ toggleBot, setToggleBot }: ChatButtonProps) {
    return (
        <button
            ...
            className="items-center justify-center px-3 py-3 overflow-hidden font-semibold text-white transition-all duration-300 bg-primary rounded-full shadow-lg hover:bg-purple-700 hover:shadow-xl active:scale-95"
        >
