    ...
    return (
      <div className="max-w-5xl mx-auto p-4">
        ...
        <div className="space-y-4">
          ...
          {course?.modules?.length > 0 && (
            <div className="text-sm text-blue-600 animate-pulse mt-2">Generating more content...</div>
          )}
        </div>
      </div>
    )
          ...
          {selectedModuleIndex !== null && selectedLessonIndex !== null ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <div className="space-y-6 p-4 text-left">
                ...
                {[...course?.modules || []].sort((a, b) => a.position - b.position).map((module, moduleIndex) => (
