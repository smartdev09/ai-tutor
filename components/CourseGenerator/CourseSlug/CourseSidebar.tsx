      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-4">
        ...
        <div className="flex items-center mb-4">
          ...
          <span className="text-sm text-gray-600 ml-2">
            {totalLessons} {text["ai-course-content"].lessons}
          </span>
        </div>

        <div className="mb-4">
          <div className="flex justify-between mb-1">
            <span className="text-sm font-medium text-gray-700">{text["ai-course-content"].progress}</span>
        ...
        <Link href="/" className="text-sm text-blue-600 hover:underline flex items-center">
          ...
          {text["ai-course-content"].back_to_tutor}
        </Link>
      </div>

      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">{text["ai-course-content"].course_outline}</h2>
          <button
            onClick={() => setIsRegenerateOpen(!isRegenerateOpen)}
            className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded text-gray-700"
          >
            {text["ai-course-content"].regenerate}
          </button>
        </div>
...
console.log("CoursesideBar lesson object:", currentLesson);
                    return (
